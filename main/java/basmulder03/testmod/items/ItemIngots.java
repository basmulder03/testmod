package basmulder03.testmod.items;
...
import basmulder03.testmod.init.ItemCore;
import basmulder03.testmod.init.ModItems;
import basmulder03.testmod.init.events.RecipeHandler;
...
public static final String[] types = new String[] { "copper", "tin", "steel"};
	...
	public ItemIngots(){
		...
		setHasSubtypes(true);
		setUnlocalizedName("testmod.ingot");
